...
void add_line(lines *line, char *n_station, char *id_station, int reverse);
...
void route_calculation(lines **line, int dim, char *station_in, char *station_out);
